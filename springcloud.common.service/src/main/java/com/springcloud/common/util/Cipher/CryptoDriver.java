package com.springcloud.common.util.Cipher;
...
public class CryptoDriver {
    ...
    public static void main(String[] args) throws GeneralSecurityException {
        ...
        String encryptText = new String(new CryptoDriver().ecbEncrypt(secretKey, "SDVtest@!59".getBytes(StandardCharsets.UTF_8)));
        System.out.println(encryptText);
        System.out.println(new CryptoDriver().ecbDecrypt(secretKey, encryptText.getBytes(StandardCharsets.UTF_8)));
    }
}
